...
// Channex incluye un prefijo en booking_unique_id que identifica la OTA real:
// BDC- = Booking.com | AIR- / HMAIR- = Airbnb | EXP- = Expedia
const detectarCanal = (r) => {
const id     = r.ota_reserva_id || "";
const canal  = r.ota_canal  || "";
...
if (uid.startsWith("BDC-") || id.startsWith("BDC-"))
return { label: "Booking.com", color: "#003580", bg: "#dbeafe" };
if (uid.startsWith("AIR-") || uid.startsWith("HMAIR-") || id.startsWith("AIR-"))
return { label: "Airbnb",      color: "#ff385c", bg: "#ffe4ea" };
if (uid.startsWith("EXP-") || id.startsWith("EXP-"))
return { label: "Expedia",     color: "#f5a623", bg: "#fff3dc" };
if (canal === "channex" || fuente === "channex")
return { label: "Channex",     color: "#2563eb", bg: "#eff6ff" };
if (canal === "sandbox")
return { label: "Sandbox",     color: "#6b7280", bg: "#f3f4f6" };
if (canal) return { label: canal, color: "#374151", bg: "#f3f4f6" };
